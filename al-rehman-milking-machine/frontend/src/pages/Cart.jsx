...
const Cart = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-5 py-10 md:py-14">
      {/* Heading */}
      <motion.h1
          ...
          {cartItems.map((item) => (
            ...
            >
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                {/* Image */}
                <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gray-100 shrink-0 flex items-center justify-center overflow-hidden rounded">
                  {item.images?.[0] ? (
                    <img
                      src={item.images[0]}
                      alt={item.name}
                ...
                <div className="flex-1 min-w-0 pr-1">
                  <div className="font-display font-semibold text-ink-950 text-sm sm:text-base leading-snug">
                    {item.name}
                  </div>

                  <div className="text-sm text-accent-600 font-semibold mt-1">
                    Rs{" "}
                  ...
                  <div className="flex items-center justify-between mt-3 sm:hidden">
                    <div className="flex items-center border border-gray-200">
                      ...
                      <span className="px-3 py-1.5 border-x border-gray-200 text-sm font-medium">
                        {item.quantity}
                      </span>
                    ...
                    <div className="font-display font-semibold text-ink-950 text-sm">
                      Rs{" "}
                      {(
                ...
                {/* Desktop Total */}
                <div className="hidden sm:block w-28 text-right font-display font-semibold text-ink-950">
                  Rs{" "}
                  {(
                    (item.discountPrice || item.price) *
                    item.quantity
      ...
      <motion.div layout className="flex justify-end mt-8">
        <div className="w-full md:w-80 bg-gray-50 border border-gray-200 p-5 sm:p-6">
          <div className="flex justify-between gap-4 mb-2 text-sm text-gray-600">
            <span>Subtotal</span>

            <span className="font-display font-semibold text-ink-950 whitespace-nowrap">
              Rs {itemsPrice.toLocaleString()}
            </span>
          </div>

          <p className="text-xs text-gray-600/70 mb-5">
